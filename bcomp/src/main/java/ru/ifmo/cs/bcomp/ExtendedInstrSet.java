...
public class ExtendedInstrSet {
	public static final Instruction[] instructions = {
		...
		new Instruction(0x0007, "PUSH", Instruction.Type.NONADDR),
		...
		new Instruction(0x000C, "ROL", Instruction.Type.NONADDR),
		new Instruction(0x000D, "ROR", Instruction.Type.NONADDR),
		new Instruction(0x000E, "RET", Instruction.Type.NONADDR),
		new Instruction(0x000F, "POP", Instruction.Type.NONADDR),
