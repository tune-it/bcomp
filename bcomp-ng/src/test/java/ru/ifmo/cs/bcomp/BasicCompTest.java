...
public class BasicCompTest {
	...
	private static final String[] TESTS = {
		...
		"8200; 200=0000; AR=200,DR=FFFF,200=FFFF", // LOOP
		"8E00; 101=FFFF; AR=101,DR=FFFE,BR=0000,101=FFFE", // LOOP
		"8C08; SP=400,408=0BEC; AR=408,DR=0BEB,BR=0008,IP=102,408=0BEB", // LOOP
