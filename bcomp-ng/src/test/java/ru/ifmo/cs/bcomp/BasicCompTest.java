...
public class BasicCompTest {
	...
	private static final String[] TESTS = {
		...
		"8200; 200=0000; AR=200,DR=FFFE,200=FFFF,IP=102", // LOOP
		"8E00; 101=FFFF; AR=101,DR=FFFD,BR=0000,101=FFFE,IP=102", // LOOP
		"8C08; SP=400,408=0BEC; AR=408,DR=0BEA,BR=0008,IP=101,408=0BEB", // LOOP
