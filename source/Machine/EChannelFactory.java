...
public class EChannelFactory 
{
	public EChannelFactory(ERegisterFactory factory, EMemory memory, EMicrocommandMemory microcommand_memory)
	{
		...
		this.channels[3] = new EChannel(factory.LeftALUInput(), factory.Accumulator());
		this.channels[4] = new EChannel(factory.LeftALUInput(), factory.StateCounter());
		this.channels[5] = new EChannel(factory.LeftALUInput(), factory.InputRegister());
		...
		this.channels[14] = new EChannel(factory.AdressRegister(), factory.AdressRegister());
	}
	...
	public EChannel AdressRegToMem()
	{
		return channels[14];
	}
